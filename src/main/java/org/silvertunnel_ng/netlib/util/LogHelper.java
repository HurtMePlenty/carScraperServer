...
public final class LogHelper
{
	 ...
	 * @param level the log-{@link java.util.logging.Level} to be checked
	...
	/**
	 * Directly log msg to desired {@link org.slf4j.Logger}.
	 * 
	 * @param logger the {@link org.slf4j.Logger} which should be used for logging
	 * @param level the log-{@link java.util.logging.Level} to be used
