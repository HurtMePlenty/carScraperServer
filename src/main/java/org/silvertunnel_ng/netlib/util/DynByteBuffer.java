...
public class DynByteBuffer
{
	 ...
	 * 
	 * @param inputStream
	 *            initial data read from an {@link java.io.InputStream}.
	 * @throws java.io.IOException when something went wrong during read or close
	 */
	...
	/**
	 * current length of data in this {@link org.silvertunnel_ng.netlib.util.DynByteBuffer}.
	 */
	...
	/**
	 * Append an byte array to the {@link org.silvertunnel_ng.netlib.util.DynByteBuffer}.
	 * 
	 * @param array
	...
	/**
	 * Appends the data from the {@link java.io.InputStream} to the current buffer.
