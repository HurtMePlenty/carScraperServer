...
public class TcpipNetAddress implements NetAddress, Serializable
{
	 ...
	 * 
	 * @param hostname the hostname
	 * @param inetAddress an {@link java.net.InetAddress} object
	 * @param port the port
	 * @throws IllegalArgumentException
	 *             if the argument could not be parsed or is invalid
	 */
	 ...
	 * 
	 * @param inetAddress
	 *            an {@link java.net.InetAddress} object
	 * @param port the port
	 * @throws IllegalArgumentException
	 *             if the argument could not be parsed or is invalid
	 */
	...
	/**
	 * @return the ip as {@link org.silvertunnel_ng.netlib.api.util.IpNetAddress} object.
	 */
	...
	/**
	 * @return get ip as {@link java.net.InetAddress} object.
	 */
