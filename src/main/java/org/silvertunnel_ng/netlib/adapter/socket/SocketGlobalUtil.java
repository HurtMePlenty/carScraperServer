...
public class SocketGlobalUtil {
     ...
     * {@link org.silvertunnel_ng.netlib.layer.tcpip.TcpipNetLayer} i.e. all requests will fail (and do NOT behave,
     ...
     * @throws IllegalStateException if initSocketImplFactory() was not called before calling this
     *                               method
     */
