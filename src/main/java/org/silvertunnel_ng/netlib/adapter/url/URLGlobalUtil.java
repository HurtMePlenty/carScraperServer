...
public class URLGlobalUtil
{
	 ...
	 * 
	 * The first lower NetLayer is {@link org.silvertunnel_ng.netlib.layer.mock.NopNetLayer} and NOT
	 * {@link org.silvertunnel_ng.netlib.layer.tcpip.TcpipNetLayer}/{@link org.silvertunnel_ng.netlib.layer.tls.TLSNetLayer} i.e. all requests will fail
	...
	public static synchronized void initURLStreamHandlerFactory(final NetlibURLStreamHandlerFactory factory)
	{
		...
		// org/silvertunnel/org.silvertunnel_ng.netlib/adapter/url/impl/net/http/HttpURLConnection$StreamingOutputStream
		// (details on
