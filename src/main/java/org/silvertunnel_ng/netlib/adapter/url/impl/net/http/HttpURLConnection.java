...
public class HttpURLConnection extends java.net.HttpURLConnection {
     ...
     *
     * @param url      the URL being accessed
     * @param useCache whether the cached connection should be used if present
     */
...
//					LOG.debug("got Exception while parsing content-length : {}", exc, exc);
     ...
     * connection.
     *
     * @param authenticationHeader the AuthenticationHeader which tells what auth scheme is
     *                             prefered.
     */
    ...
    class HttpInputStream extends FilterInputStream {
         ...
         *
         * @throws java.io.IOException if the stream has not been marked or if the mark has
         *                     been invalidated.
         * @see java.io.FilterInputStream#in
