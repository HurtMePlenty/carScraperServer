...
public class LoggingNetLayer implements NetLayer {
     ...
     * @param logContent            true=log detailed content of all traffic; false=log summary
     *                              information only
    ...
    /**
     * @see org.silvertunnel_ng.netlib.api.NetLayer#createNetSocket
     */
    @Override
    ...
    /**
     * @see org.silvertunnel_ng.netlib.api.NetLayer#createNetServerSocket
     */
    @Override
