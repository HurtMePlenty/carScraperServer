...
public class LocalProxySocket extends Socket {
     ...
     *
     * @throws java.io.IOException if an error occurs while closing the originalSocket.
     */
     ...
     * {@link java.nio.channels.SocketChannel} and that channel is in non-blocking mode then reads from the
     * stream will throw a {@link java.nio.channels.IllegalBlockingModeException}.
     *
     * @return the byte-oriented input stream.
     * @throws java.io.IOException if an error occurs while creating the input stream or the
    ...
    /**
     * Returns this originalSocket's {@link java.net.SocketOptions#SO_KEEPALIVE} setting.
     */
     ...
     * {@link java.net.InetAddress#isAnyLocalAddress()} returns true if the originalSocket is closed or unbound.
     */
     ...
     * {@link java.nio.channels.SocketChannel} and that channel is in non-blocking mode then writes to the
     * stream will throw a {@link java.nio.channels.IllegalBlockingModeException}.
     *
     * @return the byte-oriented output stream.
     * @throws java.io.IOException if an error occurs while creating the output stream or the
     *                     originalSocket is in an invalid state.
     */
    ...
    /**
     * Returns this originalSocket's {@link java.net.SocketOptions#SO_LINGER linger} timeout in seconds, or -1
    ...
    /**
     * Returns this originalSocket's {@link java.net.SocketOptions#SO_RCVBUF receive buffer size}.
     */
    ...
    /**
     * Returns this originalSocket's {@link java.net.SocketOptions#SO_SNDBUF send buffer size}.
     */
    ...
    /**
     * Returns this originalSocket's {@link java.net.SocketOptions#SO_TIMEOUT receive timeout}.
     */
    ...
    /**
     * Sets this originalSocket's {@link java.net.SocketOptions#SO_KEEPALIVE} option.
     */
    ...
    /**
     * Sets this originalSocket's {@link java.net.SocketOptions#SO_SNDBUF send buffer size}.
     */
    ...
    /**
     * Sets this originalSocket's {@link java.net.SocketOptions#SO_RCVBUF receive buffer size}.
     */
    ...
    /**
     * Sets this originalSocket's {@link java.net.SocketOptions#SO_LINGER linger} timeout in seconds.
    ...
    /**
     * Sets this originalSocket's {@link java.net.SocketOptions#SO_TIMEOUT read timeout} in milliseconds.
    ...
    /**
     * Sets this originalSocket's {@link java.net.SocketOptions#TCP_NODELAY} option.
     */
     ...
     *
     * @throws java.io.IOException     if an error occurs while closing the originalSocket input stream.
     * @throws java.net.SocketException if the input stream is already closed.
     */
     ...
     *
     * @throws java.io.IOException     if an error occurs while closing the originalSocket output stream.
     * @throws java.net.SocketException if the output stream is already closed.
     */
     ...
     * for which {@link java.net.InetAddress#isAnyLocalAddress()} returns true will be returned with the
     ...
     * @throws java.io.IOException              if the originalSocket is already bound or an error occurs while
     *                                  binding.
     */
     ...
     * @throws IllegalArgumentException if the given SocketAddress is invalid or not supported.
     * @throws java.io.IOException              if the originalSocket is already connected or an error occurs while
     *                                  connecting.
     */
