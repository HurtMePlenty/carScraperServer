...
public class MockNetLayer implements NetLayer {
     ...
     *
     * @param response                           this is the response that can later be read from the socket
     * @param allowMultipleSessions              true=multiple session are allowed (all use the same response)
     * @param waitAtEndOfResponseBeforeClosingMs if all data of response read: wait this time (milliseconds)
     ...
     *
     * @param responses                          each list element represents the response that can be read
     ...
     *
     * @param responsePerDestinationAddress      mapping: destination address-&gt;response
     * @param allowMultipleSessionsForOneAddress true=multiple session are allowed for one destination address
