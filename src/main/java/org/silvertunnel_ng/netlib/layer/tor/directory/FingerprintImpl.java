...
public final class FingerprintImpl implements Fingerprint, Cloneable, Serializable
{
	...
	/**
	 * Create an {@link org.silvertunnel_ng.netlib.layer.tor.api.Fingerprint} object by using the BASE64 encoded data.
	...
	/**
	 * Create an {@link org.silvertunnel_ng.netlib.layer.tor.api.Fingerprint} object by using the data directly from a byte array.
	 ...
	 * 
	 * @return a cloned {@link org.silvertunnel_ng.netlib.layer.tor.api.Fingerprint} object
