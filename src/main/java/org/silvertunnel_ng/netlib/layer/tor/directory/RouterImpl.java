...
public class RouterImpl implements Router, Cloneable {
     ...
     * connectToHidden().
     *
     * @param publicKey {@link java.security.interfaces.RSAPublicKey} used as onionKey
     */
     ...
     *
     * @param convenientStreamReader the {@link org.silvertunnel_ng.netlib.util.ConvenientStreamReader} which contains the data
     * @throws org.silvertunnel_ng.netlib.layer.tor.util.TorException if something went wrong during parsing
     */
    ...
    private void parseRouterDescriptor(final String routerDescriptor) throws TorException {
        ...
        for (int i = 0; i < tmpLine.length; i++) {
            ...
            for (final Iterator<Entry<RouterDescriptorFormatKeys, Integer>> it = keysToFind.entrySet().iterator(); it.hasNext(); ) {
