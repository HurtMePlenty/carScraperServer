...
public class CircuitAdmin {
     ...
     * @return a new {@link org.silvertunnel_ng.netlib.layer.tor.circuit.Circuit} object if successful (null if not)
     */
     ...
     * @param sp
     * @param torEventService
     * @return an established {@link org.silvertunnel_ng.netlib.layer.tor.circuit.Circuit}
     */
     ...
     * @param sp        tcp stream properties
     * @return a list of servers
     * @throws org.silvertunnel_ng.netlib.layer.tor.util.TorException when directory is empty
     * @see org.silvertunnel_ng.netlib.layer.tor.common.TCPStreamProperties
     */
