...
import org.silvertunnel_ng.netlib.layer.tor.directory.*;
...
public final class HiddenServiceClient
{
	...
	/** a {@link org.silvertunnel_ng.netlib.layer.tor.directory.RendezvousServiceDescriptorService} instance. */
