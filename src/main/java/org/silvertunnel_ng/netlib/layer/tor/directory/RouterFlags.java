...
public final class RouterFlags {
     ...
     *
     * @param ruleFlags {@link org.silvertunnel_ng.netlib.layer.tor.directory.RouterFlags} object which should be treated as a rule
     * @return true if this {@link org.silvertunnel_ng.netlib.layer.tor.directory.RouterFlags} matches the given rule
     */
