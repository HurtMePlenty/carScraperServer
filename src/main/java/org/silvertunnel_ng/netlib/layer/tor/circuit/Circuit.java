...
import org.silvertunnel_ng.netlib.layer.tor.circuit.cells.*;
...
public final class Circuit {
    ...
    /**
     * Saving the {@link org.silvertunnel_ng.netlib.layer.tor.common.TCPStreamProperties} for later usage.
     */
     ...
     *
     * @param fnh             a pointer to the TLS-Connection to the first node
     * @param dir             a pointer to the directory, in case an alternative route is
     *                        necessary
     * @param sp              some properties for the stream that is the reason for building
     ...
     * @throws org.silvertunnel_ng.netlib.layer.tor.util.TorException
     ...
     *
     * @param routerFingerprint the {@link org.silvertunnel_ng.netlib.layer.tor.api.Fingerprint} of the router to which the Circuit should be extended
     * @throws org.silvertunnel_ng.netlib.layer.tor.util.TorException when Fingerprint is not found in {@link Directory}
     *                      or the Circuit cannot be extended to this router as this router already is in the nodes list
     * @throws java.io.IOException  when there is a problem extending the Circuit
     */
     ...
     *
     * @param n new node that is appended to the existing route
     */
     ...
     * @throws org.silvertunnel_ng.netlib.layer.tor.util.TorException when stream id could not be set
     */
     ...
     *
     * @param stream   the {@link org.silvertunnel_ng.netlib.layer.tor.circuit.Stream} to be assigned
     * @param streamId the stream id to be assigned to the given stream
     * @return true=success, false=stream id is already in use
     * @throws org.silvertunnel_ng.netlib.layer.tor.util.TorException when Circuit is already closed
     */
     ...
     *
     * @return the last Node from this Circuits Route
     */
    ...
    /**
     * Get Nodes from the Circuits Route.
     *
    ...
    /**
     * Receive a special {@link org.silvertunnel_ng.netlib.layer.tor.circuit.cells.CellRelay}.
     *
     * @param type the type of the RELAY-cell to be received
     * @return a {@link org.silvertunnel_ng.netlib.layer.tor.circuit.cells.CellRelay} if received correctly
     * @throws org.silvertunnel_ng.netlib.layer.tor.util.TorNoAnswerException
     * @throws java.io.IOException
     * @throws org.silvertunnel_ng.netlib.layer.tor.util.TorException
     */
     ...
     *
     * @param cell the {@link org.silvertunnel_ng.netlib.layer.tor.circuit.cells.Cell}
     * @throws org.silvertunnel_ng.netlib.layer.tor.util.TorException will be thrown if there is a problem while sending a
     *                      RELAY_SENDME cell
     */
    ...
    /**
     * Get the {@link org.silvertunnel_ng.netlib.layer.tor.common.TCPStreamProperties} which have been used for creating this circuit.
     *
     * @return the {@link org.silvertunnel_ng.netlib.layer.tor.common.TCPStreamProperties} object.
     */
