...
public final class HiddenServiceDescriptorCache
{
	...
	/** instance of {@link org.silvertunnel_ng.netlib.layer.tor.hiddenservice.HiddenServiceDescriptorCache}.*/
	private static HiddenServiceDescriptorCache instance;
	/**
	 * @return get an instance of {@link org.silvertunnel_ng.netlib.layer.tor.hiddenservice.HiddenServiceDescriptorCache}.
	 */
	...
	/** cached {@link org.silvertunnel_ng.netlib.layer.tor.directory.RendezvousServiceDescriptor}. */
	 ...
	 * 
	 * - Cleans the cache.
	 * - if option in {@link org.silvertunnel_ng.netlib.layer.tor.common.TorConfig} is set it will load the saved Descriptors from disk into the cache if it is not older than 24h
	 */
	...
	/**
	 * Add a {@link org.silvertunnel_ng.netlib.layer.tor.directory.RendezvousServiceDescriptor} to the cache.
	 * @param z the onion address without .onion
	 * @param descriptor the {@link org.silvertunnel_ng.netlib.layer.tor.directory.RendezvousServiceDescriptor}
	 */
	...
	/**
	 * Try to get a cached {@link org.silvertunnel_ng.netlib.layer.tor.directory.RendezvousServiceDescriptor}.
	 * 
	 * @param z the onion address without .onion
	 * @return {@link org.silvertunnel_ng.netlib.layer.tor.directory.RendezvousServiceDescriptor} or null if not found/not valid anymore
	 */
