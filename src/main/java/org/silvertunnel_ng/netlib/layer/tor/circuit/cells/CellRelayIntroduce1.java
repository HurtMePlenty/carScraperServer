...
public class CellRelayIntroduce1 extends CellRelay {
     ...
     *
     * @param circuit                        the {@link Circuit} to be used for sending the {@link org.silvertunnel_ng.netlib.layer.tor.circuit.cells.Cell}
     ...
     * @param rendezvousPointRouter          the {@link org.silvertunnel_ng.netlib.layer.tor.api.Router} of the rendezvous point
     * @throws org.silvertunnel_ng.netlib.layer.tor.util.TorException an {@link org.silvertunnel_ng.netlib.layer.tor.util.TorException} when there is a problem with the encryption
     */
