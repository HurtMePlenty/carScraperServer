...
public final class Directory {
    ...
    private ThreadFactory namedThreadFactory = new ThreadFactoryBuilder().setNameFormat("DirectoryExecutorThread-%d").build();
    ...
    protected Map<Fingerprint, Router> parseRouterDescriptors(final String routerDescriptors) {
        ...
        executor = Executors.newFixedThreadPool(5, namedThreadFactory); // TODO : make threadpool configurable
    ...
    private void fetchDescriptors(final Map<Fingerprint, Router> fingerprintsRouters,
            ...
            throws TorException {
        final Map<Fingerprint, String> digestsOfRoutersToLoad = new ConcurrentHashMap<>();
     ...
     * @return a {@link org.silvertunnel_ng.netlib.layer.tor.api.Router}
     */
     ...
     *
     * @param ipNetAddress {@link org.silvertunnel_ng.netlib.api.util.IpNetAddress} of the router
     ...
     * Find a router by the given IP address and onion port.
     *
     * @param tcpipNetAddress {@link org.silvertunnel_ng.netlib.api.util.TcpipNetAddress} of the router to be searched
     * @return the router; null if no valid matching router found
     */
     ...
     *
     * @param sp {@link org.silvertunnel_ng.netlib.layer.tor.common.TCPStreamProperties} containing the destination infos
